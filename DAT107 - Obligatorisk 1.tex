...
\subsection{\textbf{c)} Dropp telefonnummer} Hvis det ikke er behov å lagre telefonnummeret i eier tabellen, så er det mulig å fjerne det på denne måten. 
...
\subsection{\textbf{k)} Kan vi håndtere utenlandske registreringsnummer?}
\subsection{\textbf{l)} Oppgaven ønsker egentlig 2 tabeller, hvilke andre ønsker vi?}
